...
import { 
  useLangChainMessages,
  useSendLangChainMessage,
} from "@/hooks/api/chat/useLangChainChat"
...
export default function LangChainChat() {
  ...
  // Use the LangChain chat hooks
  const {
    data: messages = [],
    isLoading: isLoadingMessages,
    refetch: refetchMessages,
  } = useLangChainMessages(activeSessionId)
  const { mutate: sendMessage, isPending: isSending } = useSendLangChainMessage()
